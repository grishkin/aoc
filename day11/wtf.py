...
#fuar this solution is crazy +1


# hardcoded input
polonium, thulium, promethium, ruthenium, cobalt, elerium, dilithium = 1, 2, 3, 4, 5, 6, 7
initial = (0, (
    tuple(sorted((-polonium, thulium, -thulium, -cobalt))),
    tuple(sorted((cobalt, polonium))), tuple(sorted((-ruthenium, -promethium,ruthenium, promethium))), ()
))
    ...
    for move in moves:
        for direction in directions:
            ...
            if next not in cost_so_far or new_cost < cost_so_far[next]:
                ...
                priority = new_cost - len(new_floors[3]) # silly manually tweakable heuristic factor
